...
HD_PWD='D:/Arquitectura de computadoras/TP1_ALUv1.0/TP1_ALUv1.1/TP1_ALUv1.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OperadorPrincipal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OperadorPrincipal.tcl -notrace
