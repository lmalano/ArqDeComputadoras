...
HD_PWD='D:/Arquitectura de computadoras/TP1_ALUv1.0/TP1_ALUv1.1/TP1_ALUv1.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OperadorPrincipal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OperadorPrincipal.tcl
